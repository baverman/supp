...
def test_imported_name_location(project):
    ...
    result = tlocation(source, p3, project, filename=project.get_m('testp.testm2'))
    assert result == [_loc((2, 24), project.get_m('testp.testm2')),
...
def test_imported_attr_location(project):
    ...
    assert locs == [
        ...
        _loc((0, 0), project.get_m('testp.testm')),
    ]
